    ...
    <div class="card">
        ...
        <form action="" id="form" class="form">
            <div class="input-wrap">
                ...
                <label class="lable log-lable" for="email">Почта</label>
            </div>
            <div class="input-wrap">
            ...
            <div class="input-wrap">
                ...
                <label class="lable log-lable" for="returnPassword">Повторить пароль</label>
            </div>       
            {{{buttonRegist}}}
            {{{buttonLink}}}
        </form>
